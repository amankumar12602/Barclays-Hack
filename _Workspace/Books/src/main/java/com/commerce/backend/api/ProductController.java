...
public class ProductController extends PublicApiController {
    ...
    public ResponseEntity<List<ProductVariantResponse>> getAll(@RequestParam("page") Integer page,
        ...
        List<ProductVariantResponse> products = productService.getAll(page, pageSize, sort, category, minPrice, maxPrice);
    ...
    public ResponseEntity<ProductDetailsResponse> getByUrl(@PathVariable("id") String id) {
        if (id.isBlank()) {
