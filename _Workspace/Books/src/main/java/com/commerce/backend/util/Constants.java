...
public class Constants {
     ...
     */
    public static final String PARAM_CLIENT_ID = "test_WC4skaFtjTDKVukMukURg0aILwcIu1vAzj9";

    /**
     * The constant PARAM_CLIENT_SECRET.
     */
    public static final String PARAM_CLIENT_SECRET = "test_JiTvxOmmuds57QJt3BTqqEIGCTaREN0hCnP0z3WO9B6yu0ghAGTYBWhuSrvOVuuVjRly0BPpIj08WVkuIxV3NMvheto8lu9sCa3sbwLhpUCENmOxINxAwPLCwwG";
    ...
    public static final String PARAM_USERNAME = "amankumarsingh2803";
     ...
     */
    public static final String PARAM_PASSWORD = "showsomestarz";
