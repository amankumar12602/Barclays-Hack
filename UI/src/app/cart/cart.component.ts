...
export class CartComponent implements OnInit, OnDestroy {
  ...
  removeFromCart(productVariantId: number) {
    this.store.dispatch(new CartActions.RemoveFromCart(productVariantId));
  }

  amountIncrement(productVariantId: number) {
    this.store.dispatch(new CartActions.IncrementCart({ productVariantId, amount: '1' }));
  }

  amountDecrement(productVariantId: number) {
    this.store.dispatch(new CartActions.DecrementCart({ productVariantId, amount: '1' }));
  }
